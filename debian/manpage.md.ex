% python-oauth2-clientd(SECTION) | User Commands
%
% "June 18 2025"
...
python-oauth2-clientd - program to do something

# SYNOPSIS

**python-oauth2-clientd** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**python-oauth2-clientd** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **python-oauth2-clientd** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**python-oauth2-clientd** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    python-oauth2-clientd. See **foo.conf**(5) for further details.
...
**python-oauth2-clientd** provides some return codes, that can be used in scripts:
...
Jeff Mahoney <jeffm@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Jeff Mahoney
